...
\begin{figure}[p]
  ...
  \subfloat[Estimation error versus number of input frames.]{
    \includegraphics[width=0.65\textwidth]{plots/error_vs_nframes}
  }
  \\
  \subfloat[A magnification of the third series above.]{
    \includegraphics[width=0.65\textwidth]{plots/error_vs_nframes_oursonly}
  }
...
\begin{figure}[tb]
  \centering
  \includegraphics[width=0.5\textwidth]{fcmap}
